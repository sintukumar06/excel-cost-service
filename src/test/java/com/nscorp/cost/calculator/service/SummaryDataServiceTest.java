...
public class SummaryDataServiceTest extends AbstractBaseTest {
    @InjectMocks
    private SummaryDataService testObj;
    @Spy
    ...
    @Test
    public void getSummaryDataList() {
        List<SummaryData> result = testObj.getSummaryDataList(getRequestInput());
